...
class AppConfig:
	...
	def load_from_env(cls) -> 'AppConfig':
		...
		providers = {
			...
			'hajimi': ProviderConfig(
				name='hajimi',
				domain='https://api2.gemai.cc',
				login_path='/login',
			...
			'jiushi': ProviderConfig(
				name='jiushi',
				domain='https://api-cf.jiushi.xin',
				login_path='/login',
				sign_in_path='/api/user/checkin',
				user_info_path='/api/user/self',
				api_user_key='new-api-user',
			...
			'kemeng': ProviderConfig(
				name='kemeng',
				domain='https://api456.me',
				login_path='/login',
				sign_in_path='/api/user/checkin',
				user_info_path='/api/user/self',
				api_user_key='new-api-user',
